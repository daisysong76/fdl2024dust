...
if __name__ == "__main__":
    ...
    label_test = label_test.view(-1, 1)  # Adjust this if the number of regression targets is different
    ...
    model = SwinTransformer3D(num_classes=1,  # Set this to match the number of regression targets
                              embed_dim=96,
                              drop_path_rate=0.1,
                              mlp_ratio=4.0,
                              patch_norm=True,
