# Classification Head:
# Objective: The goal is to categorize input data into one of several predefined classes.
# Output: Produces discrete labels or probabilities for each class.
# Activation Function: Typically uses a softmax activation function in the final layer to produce a probability distribution over classes.
# Loss Function: Commonly uses Cross-Entropy Loss for training.
# Example Use Cases: Image classification, text classification, object detection.
# -*- coding: utf-8 -*-
"""
@File    :  SWT_V2_1D.py
...
class SwinTransformer_1D(nn.Module):
    ...
    def __init__(self, seq_len=500, patch_size=4, in_chans=32, num_classes=4,
        ...
        # Classifier head 
        # TODO: change the head to regression head
