...
# window_partition: Partitions input tensors into windows.
# window_reverse: Reconstructs the original tensor from partitioned windows.
...
# get_window_size: Adjusts the window size to fit the input dimensions.
...
class SwinTransformer3D(nn.Module):
    ...
    def forward(self, x):#, return_class_scores=False):
        """Forward function."""
