...
train_sdo_path = "/home/daisysong/2024-HL-Virtual-Dosimeter/data/train_sdo_2012.pkl"
val_sdo_path = "/home/daisysong/2024-HL-Virtual-Dosimeter/data/val_sdo_2012.pkl"
test_sdo_path = "/home/daisysong/2024-HL-Virtual-Dosimeter/data/test_sdo_2012.pkl"
...
train_label_path = "/home/daisysong/2024-HL-Virtual-Dosimeter/data/train_label_2012.pkl"
val_label_path = "/home/daisysong/2024-HL-Virtual-Dosimeter/data/val_label_2012.pkl"
test_label_path = "/home/daisysong/2024-HL-Virtual-Dosimeter/data/test_label_2012.pkl"
...
model = SwinTransformer3DFineTuner (num_classes=1,  # regression
...
logging.basicConfig(filename='./logs/step_3d_2012.log', level=logging.INFO,
...
torch.save(model.state_dict(), os.path.join(outpath, 'final_3d_2012.pth'))
np.save(os.path.join(outpath, 'val_loss_2012.npy'), np.array(test_loss_list))
np.save(os.path.join(outpath, 'val_mse_2012.npy'), np.array(test_mse_list))
np.save(os.path.join(outpath, 'val_rmse_2012.npy'), np.array(test_rmse_list))
